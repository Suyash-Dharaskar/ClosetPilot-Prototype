...
export default function ClosetPilotPage() {
  ...
  return (
    <div className="w-full max-w-sm mx-auto h-screen bg-background flex flex-col relative">
      ...
      {activeTab === 'closet' && (
        <Button onClick={handleFabClick} className="absolute bottom-20 right-4 z-40 h-16 w-16 rounded-full shadow-lg" style={{ backgroundColor: '#2563EB' }}>
